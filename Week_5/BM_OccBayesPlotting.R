...
colnames(p.pred )[1:4] <- c(  "Mean", "lowCI", "highCI",
                             "Wind" ) # combine est of interce etc of coefficiet.
...
# Answer: 
ggsave("HabitatOccupancy.png", plot = last_plot(), width = 8, 
       height = 6, dpi = 300)
#or by using the Export button in the Plots tab to the right 
# 
