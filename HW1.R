...
# USING FIRST YEAR OF DATA INSTEAD 
...
# ANSWER: THE MIN MAX TEMPS ARE FOR ONE YEAR, SO NO VARIATION. NOTHING ELSE.  
#
...
# ANSWER: NO, NO APPARENT CORRELATION BETWEEN SAGEBRUSH AND CHEATGRASS
...
# ANSWER: USING LEFT WOULD ADD ALL PREDDF TO THE CLOSEDDF  
...
write.csv( closeddf, paste( getwd(),"/Data_HW1/closedf.csv", sep = "" ),  
           row.names = FALSE )

#save open dataframe in our data folder:
write.csv( opendf, paste( getwd(),"/Data_HW1/opendf.csv", sep = "" ),  
           row.names = FALSE )
