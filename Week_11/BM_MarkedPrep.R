...
# Answer: SEX RATIO VARIES BETWEEN SITES; SOME HAVE MORE MALES, SOME MORE FEMALES
#
...
# Answer: IN GENERAL, DETECTION DECLINED, BUT IN THE CASE OF SDHPLA4 IT INCREASED
# VARIABILITY BETWEEN DETECTION IN SITES BETWEEN YEARS 
#
...
table( ch$ch )
# what do you notice? 
# MANY INDIVIDUALS CAPTURED ON FIRST DAY ONLY
# NOT AS MANY CAPTURED ON FIRST OR SECOND DAY ONLY
# FEW CAPTURED ON SECOND AND THIRD, FIRST AND SECOND, OR ALL THREE DAYS
...
# answer: THERE DOES NOT APPEAR TO BE ANY SIGNIFICANT CORRELATION BETWEEN THE VARIABLES
#
...
abund <- c("shrub", "perennial", "annual", "herbaceous")
#view histograms and correlation
for( n in abund){
  hist( ik_df[,n], main = n )
}
...
# moving forward? 
# Answer: THERE IS HIGH CORRELATION BETWEEN ALL PREDICTORS
#               shrub      perennial  annual      herbaceous
# shrub       1.0000000 -0.6652996 -0.8015314 -0.8598714
# perennial  -0.6652996  1.0000000  0.4835424  0.8149528
# annual     -0.8015314  0.4835424  1.0000000  0.9013366
# herbaceous -0.8598714  0.8149528  0.9013366  1.0000000
#
# SINCE WE KNOW SHRUB INCLUDES SAGEBRUSH, I WILL PROBABLY ONLY CHOOSE 
# SHRUB. MAY ADJUST LATER...
