...
#Answer: THE NEGATIVE BINOMIAL MODEL APPEARS TO PERFORM MUCH BETTER THAN THE OTHER 
# MODELS. HOWEVER IN CLASS WE DISCUSSED THAT THIS MODEL MAY BE BIASED DUE TO HOW IT 
# INTERPRETS OVERDISPERSION VS DETECTION. ESPECIALLY WITH ONLY 20 SITES. 
#
# We test whether the Negative Binomial as an alternative distribution
Mt.full.NB  <- gmultmix(  ~ 1 + shrub,
                         ~ 1 , 
                         ~ 1 + wind + temp + effort,
                        umf.Mt, 
                        mixture = "NB",
...
# Answer: THE MT.NB AND M0.NB MODELS BOTH OUTPERFORMED THE POISSON MODEL. 
# HOWEVER ADDING THE BEHAVIOR EFFECTS IN THE MT.NB MODEL DO NOT SIGNIFICANTLY 
# INMPROVE THE AIC VALUES. 
# 
# What does it suggest: 
# Answer: BASED ON THIS, IT APPEARS THE M0.NB MODEL IS THE "BEST" MODEL
#
...
# Answer: 
# MT.FULL.NB = GAVE THE ERROR "Model fitting failed in 8 sims. "
# HOWEVER IT PASSED 3 OF 6 STATISTICS ACCORDING TO THE PVALUES

#MT.FULL.P = GAVE ERRORS "NANS" PRODUCED
# FAILED 6 OF 6 

# MB.FULL.NB = GAVE THE ERROR "Model fitting failed in 14 sims. "
# HOWEVER PASSED 5 OF 6 

# MB.FULL.P =  NO ERRORS BUT FAILED 6 OF 6 MEANING IT FAILED SUCCESSFULLY? 

# MOVING FORWARD WITH EITHER MB.FULL.NB 
# OR MT.FULL.NB, WHICHEVER DOES NOT FAIL WHEN MAKING PREDICTIONS...
...
# Answer: THERE APPEARS TO BE A NEGATIVE RELATIONSHIP BETWEEN SHRUB COVER
# AND RELATIVE ABUNDANCE, UNLIKE THE SIMULATED DATA WHICH SHOWS THE OPPOSITE. 
...
# BOTH PARTIAL DISTRIBUTION PLOTS SHOW A DECREASE IN ABUNDANCE WITH INCREASE IN 
# SHRUB COVER. HOWEVER THE MT MODEL HAS MUCH LARGER CONFIDENCE INTERVALS THAN
# THE MB MODEL
# What distribution would you choose moving forward? # 
# Answer: BASED ON THIS ANALYSIS I WOULD CHOSE THE MB MODEL. HOWEVER WITH SO MUCH 
# CORRELATION BETWEEN THE VARIABLES (DESCRIBED ABOVE) AND NOT FULLY UNDERSTANDING
# HOW THE NB MODEL TYPE IS HANDING THE OVERDISPERSION, I WOULD NEED TO DO MUCH 
# MORE RESEARCH TO BE SURE THIS IS RIGHT MODEL
